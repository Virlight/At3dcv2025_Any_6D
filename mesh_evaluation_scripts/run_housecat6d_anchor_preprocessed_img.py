...
if __name__ == '__main__':
    ...
    parser.add_argument("--preprocessed_img", type=str, default=None, help="Preprocessed image filename (optional)")
    ...
    if args.img_to_3d:
        ...
        input_image = Image.open(args.preprocessed_img).convert("RGBA")
